...
<body class="antialiased">
        ...
        <v-app>
            <v-main>
                <v-container>
                    ...
                    <v-row>
                        <v-col xs="6">
                            <div class="mt-8 p-15 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                                <h1>TreeView</h1>
                        ...
                        <v-col xs="6">
                            <div class="mt-8 p-15 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                                ...
                                <form id="search">
                                    Search
                                    <input name="query" v-model="searchMenu">
                                </form>
                                <v-json-tree :json-data="menuItems" :filter-key="searchMenu"></v-json-tree>
                            </div>
                        </v-col>
                    </v-row>
                    <v-row>
                        ...
                        <v-row>
                                ...
                                <div class="mt-8 p-15 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                                    ...
                                    <v-simple-table dense dark>
                                        <template v-slot:default>
                                            ...
                                            <tbody>
                                                <tr v-for="row in userJoins" :key="row.id">
                            ...
                            <v-col xs="6">
                                <div class="mt-8 p-15 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                                    ...
                                    <form id="search">
                                        Search
                                        <input name="query" v-model="searchJoin">
                                    </form>
                                    <v-json-tree :json-data="userJoins" :filter-key="searchJoin"></v-json-tree>
                                </div>
                            </v-col>
                        </v-row>
                </v-container>
    ...
    <script src="https://unpkg.com/v-json-tree/dist/vJsonTree.umd.js"></script>
    ...
    <script>
        ...
        new Vue({
            ...
            created: function () {
                ...
                axios.get('/api/user-joins')
                    .then(function (response) {
                        that.userJoins = response.data;
                        console.log(that.userJoins);
                    })
                    .catch(function (error) {
                        console.log('Error: ' + error);
                    });
